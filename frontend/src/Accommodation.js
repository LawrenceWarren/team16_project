      ...
      <div>
        ...
        <CardGroup>
          <Card className="border-setup">
            <Card.Img
              variant="top"
              src="https://www.britanniahotels.com/image/fit/660x340/cms/britannia/images/new/birmingham-exterior-carousel-1-660x340002.jpg"
              className="Hotel-img"
            />
